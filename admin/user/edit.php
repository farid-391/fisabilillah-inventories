                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">                        
                        ...
                        <div class="card-body">
                            ...
                            <?php 
                                $id=$_GET['id'];
                                $queryEditBook=mysqli_query($connection, "SELECT * FROM users WHERE id='$id'");
                                foreach ($queryEditBook as $data)
                            ?>
                            <div class="modal-body modal-s">
                                <form action="update.php" method="POST">
                                    <input type="hidden" class="form-control" id="editUserId" name="editUserId" value="<?php echo $data['id']?>">    
                                    <div class="mb-3">
                                        <label for="editUserEmail" class="form-label">E-Mail</label>
                                        <input type="email" class="form-control" id="editUserEmail" name="editUserEmail" placeholder="Email" value="<?php echo $data['email']?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="editUserFullName" class="form-label">Fullname</label>
                                        <input type="" class="form-control" id="editUserFullName" name="editUserFullName" placeholder="Fullname" value="<?php echo $data['full_name']?>" required>
                                    </div>   
                                    <div class="mb-3">
                                        <label for="editUserPassword" class="form-label">Password</label>
                                        <input type="password" class="form-control" id="editUserPassword" name="editUserPassword" placeholder="Password" required> 
                                    </div>                       
                                </div>
