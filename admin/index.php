...
$sqlTotalUser = ' SELECT COUNT(*) AS total_user FROM users;';
$sqlTotalInventory = ' SELECT SUM(good + bad) AS total_inventory FROM items;';

$queryTotalBook = mysqli_query($connection, $sqlTotalBook);
$queryTotalUser = mysqli_query($connection, $sqlTotalUser);
$queryTotalInventory = mysqli_query($connection, $sqlTotalInventory);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php $row = mysqli_fetch_array($queryTotalInventory);
                                            echo $row['total_inventory'];?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Book Collection</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php $row = mysqli_fetch_array($queryTotalBook);
                                            echo $row['total_book'];?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Total User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php $row = mysqli_fetch_array($queryTotalUser);
                                            echo $row['total_user'];?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
